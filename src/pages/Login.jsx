...
const Login = () => {
  ...
  return (
    <div className="min-h-screen gradient-warm flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-10 right-10 text-pink opacity-20 animate-float"
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-script text-gradient mb-2">
            Welcome Friend!
          </h1>
          <p className="text-muted-foreground">
            Enter your credentials to unlock our memories
          </p>
        </div>
