      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl w-full px-4 relative z-10">
        {menuItems.map((item) => (
          ...
          >
            ...
            {/* Icon */}
            <div
              className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${item.gradient} rounded-2xl shadow-soft mb-4 group-hover:scale-110 transition-transform duration-300`}
            >
